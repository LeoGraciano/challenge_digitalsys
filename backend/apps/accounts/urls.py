...
router.register(r'detail', vs_accounts.UserDetail,
                basename='UserDetail')

router.register(r'token', vs_accounts.TokenDetail,
                basename='TokenDetail')

router.register(r'token-update', vs_accounts.TokenUpdate,
                basename='TokenUpdate')
